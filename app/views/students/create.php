    ...
    <main class="grow container mx-auto ">
        <div class="mt-8 space-y-4">
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="space-y-2">
                        <label class="font-bold block" for="class">class</label>
                        <input class="px-4 py-2 border rounded-lg w-full" type="text" id="class" name="class" placeholder="Masukkan class">
                    </div>
                <div class="space-y-2">
